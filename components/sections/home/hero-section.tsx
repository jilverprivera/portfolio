...
export const HeroSection = () => {
  ...
  return (
    <motion.section style={{ opacity }} ref={targetRef} className="max-w-screen-2xl w-11/12 mx-auto flex items-start justify-center min-h-screen">
      <motion.div style={{ scale }} className="w-full mx-auto relative z-20 space-y-8  text-neutral-900 pointer-events-none mix-blend-difference">
        <div className="w-full py-32 ">
          <div className="w-full flex items-center justify-start text-[14rem] uppercase font-semibold h-52 tracking-wide">
            <AnimatedLetters title="Software" variants={BANNER_PROPS} color="text-neutral-900" />
          </div>
          <div className="w-full flex items-center justify-end text-[14rem]  uppercase font-semibold h-52 tracking-wide">
            <AnimatedLetters title="Developer" variants={BANNER_PROPS} color="text-neutral-900" />
          </div>
          <div className="w-2/4 flex items-center justify-between space-x-8 mt-16">
            <p className="text-base w-4/5 leading-relaxed">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam sit amet mi sapien. Aenean congue justo nec semper faucibus. Aliquam eu
              sapien eu nulla commodo efficitur. Fusce nec nibh eu lorem vestibulum ornare.
            </p>
