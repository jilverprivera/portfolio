...
export const PortfolioSection = ({ projects }: { projects: IFrontMatterV2[] }) => {
  ...
  return (
    <section ref={scope} className="max-w-screen-2xl w-11/12 mx-auto relative " id="works">
      {lastFullScreenFeature && projects.map((project) => <ProjectResume key={project.slug} project={project} />)}
