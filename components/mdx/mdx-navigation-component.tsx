...
export const MDXNavigation = ({ next, prev, typePage }: Props) => {
  return (
    <div className="max-w-screen-2xl xs:w-11/12 sm:w-11/12 md:w-11/12 lg:w-11/12 xl:w-full mx-auto py-12 grid xs:grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 xs:gap-12 sm:gap-12 md:gap-12 lg:gap-24 xl:gap-24">
