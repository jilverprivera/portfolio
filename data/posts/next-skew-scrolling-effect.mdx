...
description: 'I recently started my final project of my electronic engineering degree, in this case I needed to control the pulse of a sine wave (AC) in order to control a high power light bulb...'
isPublished: true
publishedAt: 'Mar 28, 2022'
alternate: '/post/dimmer-digital-cruce-por-cero'
coverImage: '/static/posts/Digital_dimmer/dimmer_zero_cross.png'
tags: ['NextJS', 'Programming']
---
